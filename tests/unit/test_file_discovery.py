...
class TestFileDiscovery(unittest.TestCase):
    ...
    @patch("taidy.cli.get_git_ignored_files")
    @patch("taidy.cli.is_git_repository")
    def test_discover_with_ignore_patterns(
        self, mock_is_git, mock_git_ignored, mock_load_config, mock_path
    ):
    ...
    @patch("taidy.cli.get_git_ignored_files")
    @patch("taidy.cli.is_git_repository")
    def test_discover_git_ignored_files(
        self, mock_is_git, mock_git_ignored, mock_load_config, mock_path
    ):
    ...
    @patch("taidy.cli.get_git_ignored_files")
    @patch("taidy.cli.is_git_repository")
    def test_discover_single_directory_with_files(
        self, mock_is_git, mock_git_ignored, mock_load_config, mock_path
    ):
